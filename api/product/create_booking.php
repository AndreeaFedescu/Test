...
require '../validation/validate-create-booking.php';
...
$validation = new ValidationBooking();
...
if(!$isValid) {
    foreach ($validation->getErrors() as $error) {
        ...
        // tell the user
       // echo json_encode(array("message" => "Unable to create product. Data is incomplete.<br />"));
    }
}

// make sure data is not empty
// if(!empty($data->firstName) && !empty($data->lastName) && !empty($data->email) && !empty($data->address) && !empty($data->zipCode) && !empty($data->product_id))  {
